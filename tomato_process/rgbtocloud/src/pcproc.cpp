...
TOMATODETECT::CloudIN(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud,
                      std::string Param)
{
  //decode the param
...
unsigned int TOMATODETECT::RGBDfilter()
{
  ...
  pcl::PointCloud<pcl::PointXYZRGB>::Ptr
      cloud_dist (new pcl::PointCloud<pcl::PointXYZRGB>);
  ...
  pcl::PointCloud<pcl::PointXYZRGB>::Ptr
      cloud_dist_color (new pcl::PointCloud<pcl::PointXYZRGB>);
...
unsigned int TOMATODETECT::NoiseFilter()
{
  // set output cloud
  pcl::PointCloud<pcl::PointXYZRGB>::Ptr
      cloud_dist_color_noise (new pcl::PointCloud<pcl::PointXYZRGB>);
...
int TOMATODETECT::GetCenter(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud)
{
  ...
  */
  ...
  if(orderindex>0 &&
     orderindex<=Boundingbox.size() &&
     orderindex<=Center_vector.size()){
    index = orderindex - 1;
...
float TOMATODETECT::Removeoutliner(
